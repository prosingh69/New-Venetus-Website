...
const Hero = () => {
    return (
        <section className='bg-[#F8F6F4] py-10 md:py-30 px-7 md:px-10 grid-cols-1 grid md:flex md:justify-between md:items-start border-b border-[#F3E5DE]'>
            <div>
                ...
                <div className = " grid grid-cols-1 md:flex gap-4">
                    <NavLink to="/Contact" className='flex justify-center gap-2 items-center bg-[#9c3e1b] hover:bg-[#B74B21] py-2 px-4 rounded-md text-white cursor-pointer'>
            ...
            <div className="px-4">
                <img src="/design.jpg" alt="Design Interior Picture" className='w-300 h-96 rounded-2xl object-cover' />
            </div>
        </section>
    )
}
