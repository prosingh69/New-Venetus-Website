...
const PortfolioTrust = () => {
  return (
    <div className="py-8 sm:py-12 md:py-16 px-3 sm:px-6 md:px-12 lg:px-24 bg-[#F9F8F8] border-b border-[#F3E5DE]">
      <motion.div
        className="max-w-7xl mx-auto grid grid-cols-3 gap-2 sm:gap-4 md:gap-8"
