            ...
            <div className="w-[95%] max-w-350 mx-auto px-4 relative ">
                    ...
                    <div className="flex space-x-2">
                        {testimonialsData.map((_, index) => (
                            <button
                                ...
                                className={`h-2 rounded-full transition-all duration-300 ${currentIndex === index ? 'bg-orange-500 w-6' : 'bg-orange-200 w-2'
                                    }`}
                ...
                </div>
                {
                    ...
                    <div className={` flex items-center justify-center mt-6`}>
                        <NavLink to="/Testinomial" className='border-2 border-[#BF5F3A] text-[#BF5F3A] p-2 rounded-[7px] font-semibold cursor-pointer active:scale-97 '>Read All Testimonials</NavLink>
                    </div>
                }
